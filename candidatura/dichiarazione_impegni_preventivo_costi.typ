...
= Scopo del documento
Questo documento presenta il preventivo per il progetto, calcolato sulla base della suddivisione delle ore produttive tra i vari ruoli e dei relativi costi. Sono riportati il totale delle ore produttive assegnate a ciascun membro del team e la data di consegna finale prevista.

= Impegni orari
I membri si impegnano a dedicare un totale di 90 ore produttive al progetto. Le ore necessarie per ogni singolo ruolo vengono ripartite equamente tra tutti i componenti del gruppo.

La seguente tabella riporta quanto indicato:
#table(
...
Richiede competenze nella gestione delle risorse e capacità di pianificazione, oltre alle abilità di comunicazione. 
...
Il suo ruolo, assieme a quello dell'analista, occuperà il minor numero di ore dato che si prevede non richieda un elevato dispendio temporale.
...
La necessità di questa figura risulta di fondamentale importanza solo durante le prime fasi del progetto. Richiede quindi un numero più basso di ore assegnate rispetto alla media di tutti i ruoli.
...
Si stima quindi un numero superiore alla media di ore produttive, dovute anche alla integrazione delle numerose tecnologie che si andranno ad utilizzare. 
...
Il gruppo ha stimato un costo finale di *12.670,00 €* per la realizzazione del prodotto. La data concordata dal gruppo per la consegna del prodotto è stata fissata per il giorno *21/03/2025*.