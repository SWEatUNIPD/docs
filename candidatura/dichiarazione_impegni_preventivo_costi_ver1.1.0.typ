...
#show: content=>verbale(
  ...
  versioni: (
    ...
    [- Modifica struttura documento
     ...
     - Correzione errore tipografico
     - Miglioramenti sintattici
     - Correzione registro delle modifiche],
    "1.0.0",
    "30/10/2024",
    [Davide Martinelli\ Klaudio Merja ],
    [Andrea Perozzo\ Andrea Precoma\ Davide Marin\ Davide Picello\ Riccardo Milan],
...
Si stima quindi un numero ben superiore alla media di ore produttive, dovuto anche alla necessità di integrare fra loro le numerose tecnologie che si intende utilizzare.
...
= Impegni orari
I membri si impegnano a dedicare un totale di 90 ore produttive ciscuno allo svolgimento del progetto. Le ore necessarie per ogni singolo ruolo vengono ripartite in parti uguali tra tutti i componenti del gruppo.
...
Il gruppo ha stimato un costo finale di *12.635,00 €* per la realizzazione del prodotto. 
