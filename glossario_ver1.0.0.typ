...
= B
#v(10pt)
- #text(weight: "bold", "Broker di Eventi")
...
= D
#v(10pt)
- #text(weight: "bold", "Data Visualization")
...
= S
#v(10pt)
- #text(weight: "bold", "Stream Processing")
