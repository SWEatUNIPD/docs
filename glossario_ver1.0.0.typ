...
\
La presenza di un termine o espressione all'interno del `Glossario` negli altri documenti viene indicata aggiungendogli un apice con la lettera "g" (es. SAL#rifGlossario) e sottolineando l'intera espressione (es. #underline[Apache Superset#rifGlossario]) per indicare chiaramente l'intero costrutto da cercare nel glossario.
