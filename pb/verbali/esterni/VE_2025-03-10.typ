...
Il gruppo ha presentato quanto svolto nel SAL precedente in merito alla redazione dei _test_ di accettazione e alla progettazione dell'architettura logica del prodotto. In particolare è stato chiarito quanto concluso a seguito dell'incontro con il prof. Cardin, svoltosi mercoledì 5 marzo 2025, sulle tecnologie adottate dal gruppo.

== Test di accettazione
Il gruppo ha presentato all'azienda proponente i _test_ di accettazione redatti in questo _sprint_, presentando quanto rilevato e ponendo domande per chiarire gli eventuali dubbi presentati dai membri del gruppo. L'azienda proponente ha fornito tutti i chiarimenti necessari e le indicazioni per modificare e/o aggiungere _test_ di accettazione. L'azienda tuttavia ha espresso la sua approvazione per quanto svolto dal gruppo e si attendono le modifiche proposte per il prossimo SAL.
