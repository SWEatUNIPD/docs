...
L'incontro svoltosi con l'azienda proponente ha avuto come argomenti di discussione le prime scelte architetturali adottate dal gruppo in merito alla progettazione dell'#rifGlossario("MVP") e una discussione sulle tecnologie adottate dal gruppo. Sono stati valutati nuovamente i reali casi d'uso del prodotto finale e se le scelte fatte fossero effettivamente le più adatte.
