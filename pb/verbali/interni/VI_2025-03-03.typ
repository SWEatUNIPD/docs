...
= Ordine del giorno
La riunione interna, svoltasi dopo il #rifGlossario("SAL") con l'azienda proponente per la metà del settimo _#rifGlossario("sprint")_, ha come principale obiettivo quello di discutere le scelte architetturali e mettere in piedi le attività necessarie alla scrittura della documentazione, quali scegliere i test di sistema e di accettazione. Inoltre un obiettivo per il prossimo periodo sarà quello di continuare lo sviluppo della _#rifGlossario("dashboard")_ che costituirà l'interfaccia del _software_ e concretizzare le automazioni dei test nella _pipeline_. Infine sono state discusse alcune tematiche legate al _#rifGlossario("Way of Working")_. In particolare la modalità con cui stabilire l'ultimo accesso ai puntatori alle risorse esterne e la modalità di redazione della retrospettiva di uno _sprint_ a Piano di Progetto.
...
Dopo qualche ora di ricerca sui test necessari ad assicurarsi la qualità di sistema e di accettazione, per la fine dello _sprint_ il gruppo si pone l'obiettivo di concretizzare i test e di redigere le sezioni del Piano di Qualifica inserendo gli appositi test. Tuttavia l'inserimento dei test di accettazione potrebbe avvenire anche dopo la fine dello _sprint_, in quanto essi devono essere concordati con l'azienda proponente e verranno presentati loro al SAL di fine _sprint_
