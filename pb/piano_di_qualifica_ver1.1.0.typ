...
#table(
  ...
  table.header[*Codice test*][*Descrizione*][*Requisito*][*Stato*],
    ...
    [TS-55], [Verificare che l'amministratore possa visualizzare, nella sezione dedicata ai grafici statistici, un grafico per ciascuna analisi dati], [RFF-6], [Non eseguito],
