...
#figure(
  ...
  table(
    ...
    [TA-01], [Verificare che all'apertura il prodotto mostri una mappa che visualizza in tempo reale i percorsi compiuti dai mezzi in movimento], [Superato],
    [TA-02], [Verificare che il prodotto supporti la generazione tramite LLM di annunci personalizzati per ogni utente in base ai suoi dati di profilazione], [Superato],
    [TA-03], [Verificare che il prodotto supporti la visualizzazione dei _#rifGlossario("marker")_ corrispondenti ai mezzi con noleggio attivi all'interno della mappa], [Superato], // da togliere
    [TA-04], [Verificare che il prodotto supporti la visualizzazione dei _marker_ corrispondenti ai punti di interesse all'interno della mappa], [Superato],
    [TA-05], [Verificare che il prodotto supporti la visualizzazione dei _marker_ corrispondenti agli annunci generati all'interno della mappa], [Superato],
    [TA-06], [Verificare che il prodotto supporti la visualizzazione dei _marker_ corrispondenti alle mancate generazioni di annunci all'interno della mappa], [Superato],
    [TA-07], [Verificare che il prodotto supporti la visualizzazione dei dati dei punti di interesse tramite i rispettivi _marker_ sulla mappa], [Superato],
    [TA-08], [Verificare che il prodotto supporti la visualizzazione dei dati degli annunci generati per ogni rispettivo _marker_ sulla mappa], [Superato],
    [TA-09], [Verificare che il prodotto supporti la visualizzazione dei dati delle mancate generazioni di annunci per ogni rispettivo _marker_ sulla mappa], [Superato],
    [TA-10], [Verificare che il prodotto supporti una generazione realistica dei percorsi dei noleggi], [Superato],
    [TA-11], [Verificare che il prodotto persista in un _database_ i dati simulati e quelli generati dalla LLM], [Superato],
    [TA-12], [Verificare che il prodotto sia fruibile con le ultime versioni dei _browser web_ principali, nello specifico: Google Chrome v134.0.6998.88, Mozilla Firefox v136.0.2, Microsoft Edge v134.0.3124.72 e Safari v18.3], [Superato],
  ),
)
