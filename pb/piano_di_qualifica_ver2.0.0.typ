...
#table(
  ...
  table.header[*Codice test*][*Descrizione*][*Requisito*][*Stato*],
    ...
    [TS-35], [Verificare che l'amministratore possa visualizzare, per ogni singolo elemento nello storico, l'_e-mail_ dell'utente destinatario dell'annuncio.], [RDF-6], [Verificato],
    ...
    [TS-39], [Verificare che l'amministratore possa visualizzare, attraverso i dettagli completi di un annuncio, l'_e-mail_ dell'utente destinatario di quell'annuncio.], [RDF-10], [Verificato],
    ...
    [TS-44], [Verificare che l'amministratore possa filtrare gli annunci visualizzati nello storico in base all'_e-mail_ dell'utente destinatario.], [RDF-15], [Verificato],
