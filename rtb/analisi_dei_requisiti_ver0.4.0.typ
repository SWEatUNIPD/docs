...
=== UC14 - Visualizzazione messaggio annuncio non generato tramite marker sulla mappa <uc14>
- *Attore principale*: Amministratore.
...
=== UC15 - Chiusura annuncio visualizzato tramite marker sulla mappa <uc15>
- *Attore principale*: Amministratore.
...
=== UC16 - Chiusura messaggio annuncio non generato visualizzato tramite marker sulla mappa <uc16>
- *Attore principale*: Amministratore.
...
=== UC17 - Spostamento della visuale sulla mappa <uc17>
- *Attore principale*: Amministratore.
...
#figure(
  ...
  caption: [Diagramma dei casi d'uso UC17, UC19 e UC20],
)

#pagebreak()

=== UC18 - Modifica ampiezza della visuale sulla mappa <uc18>
- *Attore principale*: Amministratore.
...
=== UC21 - Visualizzazione notifica di un annuncio generato <uc21>
- *Attore principale*: Amministratore.
...
#figure(
  ...
  caption: [Diagramma dei caso d'uso UC21, UC29, UC30, UC31],
)

#pagebreak()

=== UC22 - Visualizzazione notifica di mancata generazione di un annuncio <uc22>
- *Attore principale*: Amministratore.
...
#figure(
  ...
  caption: [Diagramma dei caso d'uso UC22, UC29, UC30, UC31],
)

#pagebreak()

=== UC23 - Apertura dettagli singolo annuncio dalla notifica <uc23>
- *Attore principale*: Amministratore.
...
#figure(
  ...
  caption: [Diagramma dei caso d'uso UC23, UC33],
)

#pagebreak()

=== UC24 - Chiusura di una notifica <uc24>
- *Attore principale*: Amministratore.
...
#figure(
  ...
  caption: [Diagramma dei casi d'uso UC26 e UC27],
)
#figure(
  image("../assets/use_cases/storico.png"),
  caption: [Diagramma dei casi d'uso UC25, UC24, UC29, UC30, UC31 e UC32],
)
