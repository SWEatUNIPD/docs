...
Un'altra domanda posta dal gruppo è stata se Apache NiFi si presti all'implementazione di logiche complesse e di design pattern, in vista del colloquio sulle tecnologie che il gruppo dovrà sostenere per il superamento dell'esame. L'azienda ci ha rassicurato, dicendoci che in genere è sufficiente riconoscere queste logiche nei _software_ che utilizziamo. Per chiarire ogni dubbio il gruppo porrà questa domanda direttamente al professor Cardin durante l'incontro fissato per giovedì 19 dicembre.
