...
Un altro piccolo dubbio era se fosse necessario, o perlomeno consigliato, "containerizzare" anche il _producer_ dei dati del simulatore. La risposta è stata affermativa in quanto questo faciliterà la replicabilità del sistema.
