...
#infoRiunione(luogo: "Google Meet", data: "13/11/2024", ora: "16:00", durata: "mezz'ora", partecipantiEsterni: ("Fabio Pallaro", "Andrea Dorigo"))
...
- *Tecnologie consigliate*: Ci è stato raccomandato un'analisi dei concetti di data streaming, data processing, broker e architettura event-driven, sottolineando l'importanza di selezionare uno strumento principale tra quelli indicati, come Kafka Streams, Nifi, Flink, o Spring (Java/Apache). Per l'integrazione con LangChain, Nifi è stato consigliato come strumento ottimale. Questi strumenti, una volta selezionati, dovranno essere applicati considerando i casi d'uso specifici e le potenziali esigenze di progetto.
...
Ci è stata confermata l'autonomia del team, si sono offerti disponibili a fornire feedback su richiesta e durante gli incontri periodici. L'approccio organizzativo suggerito con sprint bisettimanali e milestone ben definite permetterà di avanzare nel progetto in modo controllato e con momenti di verifica frequenti. È stato raccomandato un approccio "agile", mantenendo flessibilità nella gestione dei requisiti e definendo con sicurezza quelli essenziali. Per la gestione dei dati, dovremmo valutare se separare lo storage per dati statici e dinamici o integrarli in un unico database, considerando la complessità.
