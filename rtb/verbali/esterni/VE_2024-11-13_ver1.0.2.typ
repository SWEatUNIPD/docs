...
Durante l'incontro, ci sono stati forniti suggerimenti su tecnologie, metodologie, gestione delle comunicazioni e organizzazione del progetto. Abbiamo discusso dell'autonomia nella scelta di strumenti e best practice. Sono stati fissati obiettivi legati alla gestione delle milestone e degli sprint bisettimanali, oltre a consigli specifici sulla documentazione, il project management e la scelta delle tecnologie. Inoltre ci hanno fornito un server Discord per le comunicazioni e supporto su repository #rifGlossario("GitHub"), con feedback periodici sugli avanzamenti del progetto.

= Risposte alle domande
== Analisi dei requisiti
- *Tecnologie consigliate*: Ci è stato raccomandato un'analisi dei concetti di #rifGlossario("data streaming"), #rifGlossario("data processing"), #rifGlossario("data broker") e architettura #rifGlossario("event-driven"), sottolineando l'importanza di selezionare uno strumento principale tra quelli indicati, come #rifGlossario("Apache Kafka"), #rifGlossario("Apache Nifi"), #rifGlossario("Apache Flink"), o #rifGlossario("Spring") (Java/Apache). Per l'integrazione con #rifGlossario("LangChain"), Nifi è stato consigliato come strumento ottimale. Questi strumenti, una volta selezionati, dovranno essere applicati considerando i casi d'uso specifici e le potenziali esigenze di progetto.
...
Ci è stata data autonomia nella scelta di metodologie e strumenti, con l'opzione di chiedere assistenza o riferimenti all'azienda su best practice per versionamento, commit (ad esempio Conventional Commits), #rifGlossario("Git") e #rifGlossario("GitLab"). Per facilitare la collaborazione, si consiglia di mantenere e catalogare le best practice all'interno della repository, in cui Andrea Dorigo sarà invitato come collaboratore per monitorare l'avanzamento. È stato suggerito di utilizzare #rifGlossario("Docker") Compose per creare un ambiente containerizzato, evitando l'overhead di #rifGlossario("Kubernetes"), che risulta eccessivo per le necessità attuali.
...
== Organizzazione incontri settimanali (#rifGlossario("SAL"))
