...
- I codici delle attività sono strutturati nel seguente modo: *[X][\#ID issue]* dove X è una lettera che identifica univocamente la repository, seguita dall'ID della _issue_ scritta con quattro cifre così da mantenere una lunghezza fissa fino alla _issue_ numero 9999 per ciascuna repository. Le lettere che identificano le repository al momento sono *D* per la documentazione e *S* per il sito. Nel caso le attività non corrispondessero a delle issue perché di natura organizzativa (ad esempio richiedere un incontro all'azienda proponente) si aggiunge il codice *ORG*.
...
#backlog(content: (
  "ORG",
  "Andrea Precoma",
  "Richiesta di un incontro con l'azienda proponente via e-mail",
  "ORG",
  "Gruppo",
  ...
  "Klaudio Merja",
  "Modificare la Action per la compilazione dei verbali da firmare e per la visualizzazione artefatti della PR",
