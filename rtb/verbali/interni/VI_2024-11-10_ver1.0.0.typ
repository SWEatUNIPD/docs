...
Dopo alcune proposte stilistiche riguardo al sito dove pubblicare la documentazione abbiamo deciso di aggiornarci alla prossima riunione. Abbiamo quindi creato la repository *sweatunipd.github.io* che dovrà contenere i file relativi alla struttura del sito (HTML, CSS e JavaScript). Nei giorni successivi andremo a definire meglio l'organizzazione e le funzionalità della repository.
