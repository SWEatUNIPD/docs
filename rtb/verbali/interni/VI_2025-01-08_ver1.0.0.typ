...
= Sintesi
Sono state chiarite delle questioni importanti riguardo le metriche e i casi d'suo. Per ogni attività e documento sono stati analizzati i punti da concludere nel quinto _#rifGlossario("sprint")_.

= Ordine del giorno
La riunione interna ha avuto come obiettivi quelli di concordare definitivamente le metriche, chiarire gli ultimi dubbi riguardo i casi d'suo, concludere lo _sprint_ con una breve retrospettiva e pianificare il quinto _sprint_.
...
== Analisi dei requisiti e dei casi d'suo
Andrea Precoma e Andrea Perozzo hanno presentato i casi d'suo sui quali nutrivano alcuni dubbi e sui quali, in seguito alla discussione con la proponente, bisogna lavorare nello _sprint_ a seguire. Andranno eliminati i casi d'suo relativi alle notifiche degli annunci generati e descritte in maggior dettagli le precondizioni e postcondizioni. Questa operzione implica la creazione di nuovi casi d'suo che prima rientravano in alcuni più generici. Specificare le precondizioni e postcondizioni infatti diversifica gli scenari e risulta quindi impossibile riutilizzare certi casi d'suo.
...
= Conclusioni
Abbiamo consolidato una buona base di lavoro e pianifichiamo di ultimare i progetti rimanenti per la consegna della prima _milestone_. I lavori da concludere riguardano perfezionare i documenti di carattere generale, definire definitivamente e utilizzare le metriche scelte e perfezionare il #rifGlossario("PoC").
