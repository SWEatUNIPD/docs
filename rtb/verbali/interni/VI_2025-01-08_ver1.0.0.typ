...
Andrea Precoma e Andrea Perozzo hanno presentato i casi d'uso sui quali nutrivano alcuni dubbi e sui quali, in seguito alla discussione con la proponente, bisogna lavorare nello _sprint_ a seguire. Andranno eliminati i casi d'uso relativi alle notifiche degli annunci generati e descritte in maggior dettaglio le precondizioni e postcondizioni. Questa operazione implica la creazione di nuovi casi d'uso che prima rientravano in alcuni più generici. Specificare le precondizioni e postcondizioni infatti diversifica gli scenari e risulta quindi impossibile riutilizzare certi casi d'uso.
