...
- *Piano di Progetto:* Redazione della prima versione con lo sprint attuale (13/11/2024 - 27/11/2024).
- *Rendicontazione:* Utilizzo del foglio Excel condiviso per il monitoraggio delle ore lavorative.
...
#backlog(content: (
  ...
  link("https://github.com/SWEatUNIPD/docs/issues/34")[#text(underline("D0034"))],
  "Andrea Perozzo",
  "Redigere verbale esterno 2024-11-20",
  link("https://github.com/SWEatUNIPD/docs/issues/35")[#text(underline("D0035"))],
  "Andrea Perozzo",
  "Redigere verbale interno 2024-11-20",
  link("https://github.com/SWEatUNIPD/docs/issues/37")[#text(underline("D0037"))],
  "Klaudio Merja",
